...
<body class="skin-default-dark fixed-layout">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                <th>用户名</th><th>密码</th><th>班级</th><th>学号</th><th>性别</th><th>电话</th> <c:if test="${admin.u_authority==2 }"><th>权限</th></c:if><th>操作</th>
                                            </tr>
                                        </thead>
                                        <tbody>
										...
										<input type="hidden" name="id" value="${user.id }" />
												 <td><input type="text" class="form-control form-control-line" name="username" value="${user.u_username}"></td>
												 <td><input type="text" class="form-control form-control-line" name="password" value="${user.u_password}"></td>
												 <td><input type="text" class="form-control form-control-line" name="class" value="${user.u_classes}"></td>
												 <td><input type="text" class="form-control form-control-line" name="number" value="${user.u_number}"></td>
												 <td><input type="text" class="form-control form-control-line" name="sex" value="${user.u_sex}"></td>
												 <td><input type="text" class="form-control form-control-line" name="tel" value="${user.u_tel}"></td>
												 <c:if test="${admin.u_authority==2 }">
												   <td><input type="text" class="form-control form-control-line" name="authority" value="${user.u_authority}"></td>
												  </c:if>
												  <c:if test="${admin.u_authority!=2 }">
												   <input type="hidden" class="form-control form-control-line" name="authority" value="${user.u_authority}">
												  </c:if>
												 <input type="hidden" name="auth" value="${admin.id}" />
												 <td><button class="label label-danger" type="submit">修改</button></td>
										</form>
										</tr>
	...
	<script>
	function func(){window.location.href='index.jsp';}
